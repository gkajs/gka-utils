...
// html
function getHtmlWrap(gkaVersion, tplName, tplVersion) {
    var headContent = [],
        bodyContent = [];

    var ribbon = getRibbon(gkaVersion, tplName, tplVersion);
...
<head>
    ...
    <script name='gkaRibbon'>document.addEventListener('DOMContentLoaded',function(){var d=document.createElement('div');d.innerHTML='${ribbon}';document.body.appendChild(d)});</script>
